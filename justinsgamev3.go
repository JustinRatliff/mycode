...
// print out the number of times the player has made a guess
        ...
        if try == 2 {
            // if the number of tries is equal to 2, print game over and also the correct number and answer

            fmt.Printf("Game over!!\n ")
            fmt.Printf("The correct number is %d\n", secretNumber)
		if secretNumber == 0 {
		fmt.Println("The answer was ARMY!")}
                if secretNumber == 1 {
		fmt.Println("The answer was Air Force!")}
		if secretNumber == 2 {
		fmt.Println("The answer was Navy!")}
                if secretNumber == 3 {
		fmt.Println("The answer was Marines!")}
		if secretNumber == 4 {
		fmt.Println("The answer was Coast Guard!")}
                if secretNumber == 5 {
		fmt.Println("The answer was Space Force!")}
            break
        }
